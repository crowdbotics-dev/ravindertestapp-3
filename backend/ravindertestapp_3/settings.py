"""
Django settings for ravindertestapp_3 project.
...
ROOT_URLCONF = 'ravindertestapp_3.urls'
...
WSGI_APPLICATION = 'ravindertestapp_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ravindertestapp_3 API",
    "DESCRIPTION": "API documentation for ravindertestapp_3 App",
    "VERSION": "v1",
}
